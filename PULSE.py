...
class PULSE(torch.nn.Module):
    def __init__(self, cache_dir, verbose=True):
        ...
        with open_url("https://drive.google.com/uc?id=1PTBQiz1tn5Hjlq7f09RDWKYy2uIH22FD", cache_dir=cache_dir, verbose=verbose) as f:
        ...
        if Path("gaussian_fit.pt").exists():
            ...
            with open_url("https://drive.google.com/uc?id=1nSxcK4ST1WBt0Sb3dUeJPFcZ0uOmGyiP", cache_dir=cache_dir, verbose=verbose) as f:
